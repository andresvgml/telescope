...
<body>
    <div id="telescope" v-cloak>
        ...
        @php
            $disabled = explode(',', config('telescope.parameters.disabled'));
        @endphp
        ...
        <div class="container mb-5">
            <div class="d-flex align-items-center py-4 header">
                ...
                <button class="btn btn-outline-primary d-block d-sm-none mr-3" type="button" data-toggle="collapse" data-target="#bd-docs-nav" aria-controls="bd-docs-nav" aria-expanded="false" aria-label="Toggle navigation">
                    <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="bars" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" class="icon fill-primary"><path fill="currentColor" d="M16 132h416c8.837 0 16-7.163 16-16V76c0-8.837-7.163-16-16-16H16C7.163 60 0 67.163 0 76v40c0 8.837 7.163 16 16 16zm0 160h416c8.837 0 16-7.163 16-16v-40c0-8.837-7.163-16-16-16H16c-8.837 0-16 7.163-16 16v40c0 8.837 7.163 16 16 16zm0 160h416c8.837 0 16-7.163 16-16v-40c0-8.837-7.163-16-16-16H16c-8.837 0-16 7.163-16 16v40c0 8.837 7.163 16 16 16z" class=""></path></svg>
                </button>
                ...
                <div class="d-none d-md-flex">
                    ...
                    <h4 class="mb-0 ml-2">
                        @if(config('telescope.parameters.title'))
                            <strong>{{ config('telescope.parameters.title') }}</strong>
                        @else
                            <strong>Laravel</strong> Telescope{{ config('app.name') ? ' - ' . config('app.name') : '' }}
                        @endif
                    </h4>
                </div>
            ...
            <div class="row mt-4">
                <div class="col-md-2 col-sm-12 sidebar">
                    <nav class="bd-links collapse mb-3" id="bd-docs-nav">
                        @auth
                            <div class="profile-section d-flex flex-row justify-content-around pb-2">
                                <div class="align-self-center text-nowrap text-truncate">
                                    <img alt="{{Auth::user()->name}}" title="{{Auth::user()->name}}" class="img-fluid img-avatar" src="{{Auth::user()->avatar}}">
                                    <small class="mb-0 ml-2"><b>{{Auth::user()->name}}</b></small>
                                </div>
                        ...
                        <ul class="nav flex-column mt-2">
                            ...
                            @endif
                            @if (!in_array('Exceptions', $disabled))
                                <li class="nav-item">
                            ...
                            @endif
                            @if (!in_array('Notifications', $disabled))
                                <li class="nav-item">
                            ...
                            @auth
                                <li class="nav-item">
                                    <a href="{{ url('logout') }}" class="nav-link d-none d-md-flex align-items-center">
                                        <svg width="1792" height="1792" viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg"><path d="M704 1440q0 4 1 20t.5 26.5-3 23.5-10 19.5-20.5 6.5h-320q-119 0-203.5-84.5t-84.5-203.5v-704q0-119 84.5-203.5t203.5-84.5h320q13 0 22.5 9.5t9.5 22.5q0 4 1 20t.5 26.5-3 23.5-10 19.5-20.5 6.5h-320q-66 0-113 47t-47 113v704q0 66 47 113t113 47h312l11.5 1 11.5 3 8 5.5 7 9 2 13.5zm928-544q0 26-19 45l-544 544q-19 19-45 19t-45-19-19-45v-288h-448q-26 0-45-19t-19-45v-384q0-26 19-45t45-19h448v-288q0-26 19-45t45-19 45 19l544 544q19 19 19 45z"/></svg>
                                        <span>Logout</span>
                                    </a>
                                </li>
